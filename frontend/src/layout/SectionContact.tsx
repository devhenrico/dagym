...
export function SectionContact() {
  ...
  return (
    ...
    >
      <div className="relative flex max-w-6xl flex-col items-center gap-4 rounded-2xl border border-neutral-800/50 bg-[url('./assets/images/bg.png')] bg-cover p-6 sm:gap-5 sm:p-12 md:gap-7 md:p-16 lg:p-24">
